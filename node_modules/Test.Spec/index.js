...
var showResult = new Prelude.Show(function (_629) {
    if (_629 instanceof Success) {
        return "Success";
    };
    if (_629 instanceof Failure) {
        return "Failure (Error ...)";
    };
    throw new Error("Failed pattern match");
});
var showGroup = new Prelude.Show(function (_632) {
    if (_632 instanceof Describe) {
        return "Describe " + (Prelude.show(Prelude.showString)(_632.value0) + (" " + Prelude.show(Prelude.showArray(showGroup))(_632.value1)));
    };
    if (_632 instanceof It) {
        return "It " + (Prelude.show(Prelude.showString)(_632.value0) + (" " + Prelude.show(showResult)(_632.value1)));
    };
    if (_632 instanceof Pending) {
        return "Describe " + Prelude.show(Prelude.showString)(_632.value0);
    };
    throw new Error("Failed pattern match");
});
...
var eqResult = new Prelude.Eq(function (r1) {
    ...
    return function (_631) {
        if (_630 instanceof Success && _631 instanceof Success) {
            return true;
        };
        if (_630 instanceof Failure && _631 instanceof Failure) {
            return true;
        };
        return false;
    };
...
var eqGroup = new Prelude.Eq(function (r1) {
    ...
    return function (_634) {
        if (_633 instanceof Describe && _634 instanceof Describe) {
            return _633.value0 === _634.value0 && Prelude["=="](Prelude.eqArray(eqGroup))(_633.value1)(_634.value1);
        };
        if (_633 instanceof It && _634 instanceof It) {
            return _633.value0 === _634.value0 && Prelude["=="](eqResult)(_633.value1)(_634.value1);
        };
        if (_633 instanceof Pending && _634 instanceof Pending) {
