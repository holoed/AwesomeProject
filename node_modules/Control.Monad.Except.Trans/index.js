        ...
        var mapLeft = function (f_1) {
            return function (_147) {
                ...
                if (_147 instanceof Data_Either.Left) {
                    return new Data_Either.Left(f_1(_147.value0));
                };
...
var applyExceptT = function (__dict_Apply_10) {
    return new Prelude.Apply(function (_148) {
        return function (_149) {
            var f$prime = Prelude["<$>"](__dict_Apply_10["__superclass_Prelude.Functor_0"]())(Prelude["<*>"](Data_Either.applyEither))(_148);
            var x$prime = Prelude["<*>"](__dict_Apply_10)(f$prime)(_149);
            return x$prime;
        };
    }, function () {
