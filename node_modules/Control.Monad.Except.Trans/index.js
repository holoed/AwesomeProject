        ...
        var mapLeft = function (f_1) {
            return function (_158) {
                if (_158 instanceof Data_Either.Right) {
                    return new Data_Either.Right(_158.value0);
                };
                if (_158 instanceof Data_Either.Left) {
                    return new Data_Either.Left(f_1(_158.value0));
                };
...
var applyExceptT = function (__dict_Apply_10) {
    return new Prelude.Apply(function (_159) {
        return function (_160) {
            var f$prime = Prelude["<$>"](__dict_Apply_10["__superclass_Prelude.Functor_0"]())(Prelude["<*>"](Data_Either.applyEither))(_159);
            var x$prime = Prelude["<*>"](__dict_Apply_10)(f$prime)(_160);
            return x$prime;
        };
    }, function () {
