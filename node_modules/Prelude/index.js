...
var showUnit = new Show(function (_73) {
    return "Unit {}";
});
var showString = new Show(showStringImpl);
var showOrdering = new Show(function (_83) {
    if (_83 instanceof LT) {
        return "LT";
    };
    if (_83 instanceof GT) {
        return "GT";
    };
    if (_83 instanceof EQ) {
        return "EQ";
    };
    throw new Error("Failed pattern match");
});
var showNumber = new Show(showNumberImpl);
var showBoolean = new Show(function (_74) {
    if (_74) {
        return "true";
    };
    if (!_74) {
...
var semigroupUnit = new Semigroup(function (_91) {
    return function (_92) {
        return {};
    };
});
var semigroupString = new Semigroup(concatString);
var semigroupOrdering = new Semigroup(function (_84) {
    return function (y) {
        if (_84 instanceof LT) {
            return LT.value;
        };
        if (_84 instanceof GT) {
            return GT.value;
        };
...
var eqUnit = new Eq(function (_79) {
    return function (_80) {
        return false;
    };
}, function (_77) {
...
var $less = function (__dict_Ord_12) {
    return function (a1) {
        return function (a2) {
            var _720 = compare(__dict_Ord_12)(a1)(a2);
            if (_720 instanceof LT) {
                return true;
            };
            return false;
        };
...
var $less$eq = function (__dict_Ord_13) {
    return function (a1) {
        return function (a2) {
            var _721 = compare(__dict_Ord_13)(a1)(a2);
            if (_721 instanceof GT) {
                return false;
            };
            return true;
        };
...
var $greater = function (__dict_Ord_14) {
    return function (a1) {
        return function (a2) {
            var _722 = compare(__dict_Ord_14)(a1)(a2);
            if (_722 instanceof GT) {
                return true;
            };
            return false;
        };
...
var $greater$eq = function (__dict_Ord_15) {
    return function (a1) {
        return function (a2) {
            var _723 = compare(__dict_Ord_15)(a1)(a2);
            if (_723 instanceof LT) {
                return false;
            };
            return true;
        };
...
var ordArray = function (__dict_Ord_11) {
    return new Ord(function () {
        ...
        return function (_90) {
            ...
            if (_89.length >= 1) {
                var _730 = _89.slice(1);
                if (_90.length >= 1) {
                    var _728 = _90.slice(1);
                    var _726 = compare(__dict_Ord_11)(_89[0])(_90[0]);
                    if (_726 instanceof EQ) {
                        return compare(ordArray(__dict_Ord_11))(_730)(_728);
                    };
                    return _726;
                };
            };
