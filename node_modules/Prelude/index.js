...
var showUnit = new Show(function (_60) {
    return "Unit {}";
});
var showString = new Show(showStringImpl);
var showOrdering = new Show(function (_70) {
    if (_70 instanceof LT) {
        return "LT";
    };
    if (_70 instanceof GT) {
        return "GT";
    };
    if (_70 instanceof EQ) {
        return "EQ";
    };
    throw new Error("Failed pattern match");
});
var showNumber = new Show(showNumberImpl);
var showBoolean = new Show(function (_61) {
    if (_61) {
        return "true";
    };
    if (!_61) {
...
var semigroupUnit = new Semigroup(function (_78) {
    return function (_79) {
        return {};
    };
});
var semigroupString = new Semigroup(concatString);
var semigroupOrdering = new Semigroup(function (_71) {
    return function (y) {
        if (_71 instanceof LT) {
            return LT.value;
        };
        if (_71 instanceof GT) {
            return GT.value;
        };
        if (_71 instanceof EQ) {
            return y;
        };
        throw new Error("Failed pattern match");
    };
...
var eqUnit = new Eq(function (_66) {
    return function (_67) {
        return false;
    };
}, function (_64) {
...
var $less = function (__dict_Ord_12) {
    return function (a1) {
        return function (a2) {
            var _716 = compare(__dict_Ord_12)(a1)(a2);
            if (_716 instanceof LT) {
                return true;
            };
            return false;
        };
...
var $less$eq = function (__dict_Ord_13) {
    return function (a1) {
        return function (a2) {
            var _717 = compare(__dict_Ord_13)(a1)(a2);
            if (_717 instanceof GT) {
                return false;
            };
            return true;
        };
...
var $greater = function (__dict_Ord_14) {
    return function (a1) {
        return function (a2) {
            var _718 = compare(__dict_Ord_14)(a1)(a2);
            if (_718 instanceof GT) {
                return true;
            };
            return false;
        };
...
var $greater$eq = function (__dict_Ord_15) {
    return function (a1) {
        return function (a2) {
            var _719 = compare(__dict_Ord_15)(a1)(a2);
            if (_719 instanceof LT) {
                return false;
            };
            return true;
        };
...
var ordArray = function (__dict_Ord_11) {
    return new Ord(function () {
        ...
        return function (_77) {
            ...
            if (_76.length >= 1) {
                var _726 = _76.slice(1);
                if (_77.length >= 1) {
                    var _724 = _77.slice(1);
                    var _722 = compare(__dict_Ord_11)(_76[0])(_77[0]);
                    if (_722 instanceof EQ) {
                        return compare(ordArray(__dict_Ord_11))(_726)(_724);
                    };
                    return _722;
                };
            };
...
var eqOrdering = new Eq(function (x) {
    ...
    return function (_69) {
        if (_68 instanceof LT && _69 instanceof LT) {
            return true;
        };
        if (_68 instanceof GT && _69 instanceof GT) {
            return true;
        };
        if (_68 instanceof EQ && _69 instanceof EQ) {
            return true;
        };
        return false;
    };
