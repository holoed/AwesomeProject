...
var $less = function (__dict_Ord_12) {
    return function (a1) {
        return function (a2) {
            var _711 = compare(__dict_Ord_12)(a1)(a2);
            if (_711 instanceof LT) {
                return true;
            };
            return false;
        };
...
var $less$eq = function (__dict_Ord_13) {
    return function (a1) {
        return function (a2) {
            var _712 = compare(__dict_Ord_13)(a1)(a2);
            if (_712 instanceof GT) {
                return false;
            };
            return true;
        };
...
var $greater = function (__dict_Ord_14) {
    return function (a1) {
        return function (a2) {
            var _713 = compare(__dict_Ord_14)(a1)(a2);
            if (_713 instanceof GT) {
                return true;
            };
            return false;
        };
...
var $greater$eq = function (__dict_Ord_15) {
    return function (a1) {
        return function (a2) {
            var _714 = compare(__dict_Ord_15)(a1)(a2);
            if (_714 instanceof LT) {
                return false;
            };
            return true;
        };
...
var ordArray = function (__dict_Ord_11) {
    return new Ord(function () {
        ...
        return function (_81) {
            ...
            if (_80.length >= 1) {
                var _721 = _80.slice(1);
                if (_81.length >= 1) {
                    var _719 = _81.slice(1);
                    var _717 = compare(__dict_Ord_11)(_80[0])(_81[0]);
                    if (_717 instanceof EQ) {
                        return compare(ordArray(__dict_Ord_11))(_721)(_719);
                    };
                    return _717;
                };
            };
