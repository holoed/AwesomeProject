...
var semigroupCanceler = new Prelude.Semigroup(function (_296) {
    return function (_297) {
        return function (e) {
            return Prelude["<*>"](applyAff)(Prelude["<$>"](functorAff)(Prelude["||"](Prelude.boolLikeBoolean))(_296(e)))(_297(e));
        };
    };
});
