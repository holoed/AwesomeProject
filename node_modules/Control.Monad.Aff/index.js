...
var semigroupCanceler = new Prelude.Semigroup(function (_305) {
    return function (_306) {
        return function (e) {
            return Prelude["<*>"](applyAff)(Prelude["<$>"](functorAff)(Prelude["||"](Prelude.boolLikeBoolean))(_305(e)))(_306(e));
        };
    };
});
