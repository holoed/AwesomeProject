...
var unzip = function (_235) {
    if (_235.length >= 1) {
        var _1026 = _235.slice(1);
        var _1020 = unzip(_1026);
        return new Tuple(Prelude[":"]((_235[0]).value0)(_1020.value0), Prelude[":"]((_235[0]).value1)(_1020.value1));
    };
    if (_235.length === 0) {
        return new Tuple([  ], [  ]);
    };
...
var uncurry = function (f) {
    return function (_234) {
        return f(_234.value0)(_234.value1);
    };
};
var swap = function (_236) {
    return new Tuple(_236.value1, _236.value0);
};
var snd = function (_233) {
    return _233.value1;
};
var showTuple = function (__dict_Show_0) {
    return function (__dict_Show_1) {
        return new Prelude.Show(function (_237) {
            return "Tuple (" + (Prelude.show(__dict_Show_0)(_237.value0) + (") (" + (Prelude.show(__dict_Show_1)(_237.value1) + ")")));
        });
    };
};
var semigroupoidTuple = new Prelude.Semigroupoid(function (_242) {
    return function (_243) {
        return new Tuple(_243.value0, _242.value1);
    };
});
    ...
    return function (__dict_Semigroup_3) {
        return new Prelude.Semigroup(function (_244) {
            return function (_245) {
                return new Tuple(Prelude["<>"](__dict_Semigroup_2)(_244.value0)(_245.value0), Prelude["<>"](__dict_Semigroup_3)(_244.value1)(_245.value1));
            };
        });
    };
};
...
var functorTuple = new Prelude.Functor(function (f) {
    return function (_246) {
        return new Tuple(_246.value0, f(_246.value1));
    };
});
var fst = function (_232) {
    return _232.value0;
};
var lazyLazy1Tuple = function (__dict_Lazy1_9) {
    return function (__dict_Lazy1_10) {
        return new Control_Lazy.Lazy(function (f) {
            return new Tuple(Control_Lazy.defer1(__dict_Lazy1_9)(function (_228) {
                return fst(f(Prelude.unit));
            }), Control_Lazy.defer1(__dict_Lazy1_10)(function (_229) {
...
var lazyLazy2Tuple = function (__dict_Lazy2_11) {
    return function (__dict_Lazy2_12) {
        return new Control_Lazy.Lazy(function (f) {
            return new Tuple(Control_Lazy.defer2(__dict_Lazy2_11)(function (_230) {
                return fst(f(Prelude.unit));
            }), Control_Lazy.defer2(__dict_Lazy2_12)(function (_231) {
                return snd(f(Prelude.unit));
            }));
        });
    };
...
var lazyTuple = function (__dict_Lazy_13) {
    return function (__dict_Lazy_14) {
        return new Control_Lazy.Lazy(function (f) {
            return new Tuple(Control_Lazy.defer(__dict_Lazy_13)(function (_226) {
                return fst(f(Prelude.unit));
            }), Control_Lazy.defer(__dict_Lazy_14)(function (_227) {
                return snd(f(Prelude.unit));
            }));
        });
    };
...
var extendTuple = new Control_Extend.Extend(function (f) {
    return function (_250) {
        return new Tuple(_250.value0, f(_250));
    };
}, function () {
    return functorTuple;
});
    ...
    return function (__dict_Eq_16) {
        return new Prelude.Eq(function (t1) {
            ...
            return function (_239) {
                return Prelude["=="](__dict_Eq_15)(_238.value0)(_239.value0) && Prelude["=="](__dict_Eq_16)(_238.value1)(_239.value1);
            };
        });
    };
};
    ...
    return function (__dict_Ord_5) {
        return new Prelude.Ord(function () {
            ...
            return function (_241) {
                var _1077 = Prelude.compare(__dict_Ord_4)(_240.value0)(_241.value0);
                if (_1077 instanceof Prelude.EQ) {
                    return Prelude.compare(__dict_Ord_5)(_240.value1)(_241.value1);
                };
                return _1077;
            };
        });
...
var applyTuple = function (__dict_Semigroup_18) {
    return new Prelude.Apply(function (_247) {
        return function (_248) {
            return new Tuple(Prelude["<>"](__dict_Semigroup_18)(_247.value0)(_248.value0), _247.value1(_248.value1));
        };
    }, function () {
        return functorTuple;
    });
...
var bindTuple = function (__dict_Semigroup_17) {
    return new Prelude.Bind(function (_249) {
        return function (f) {
            var _1090 = f(_249.value1);
            return new Tuple(Prelude["<>"](__dict_Semigroup_17)(_249.value0)(_1090.value0), _1090.value1);
        };
    }, function () {
