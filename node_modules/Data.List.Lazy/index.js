            ...
            var foldMap$prime = function (l_1) {
                var g = function (_609) {
                    ...
                    if (_609 instanceof Data_Maybe.Just) {
                        return Prelude["<>"](__dict_Monoid_0["__superclass_Prelude.Semigroup_0"]())(f(_609.value0.value0))(foldMap$prime(_609.value0.value1));
                    };
                    throw new Error("Failed pattern match");
                };
                return g(Data_Lazy.force(uncons(Data_Lazy.monadLazy)(l_1)));
            };
            return foldMap$prime(_606);
        };
    };
}, function (f) {
    return function (b) {
        return function (_605) {
            var foldl$prime = function (b_2) {
                return function (l_1) {
                    var g = function (_608) {
                        if (_608 instanceof Data_Maybe.Nothing) {
                            return b_2;
                        };
                        if (_608 instanceof Data_Maybe.Just) {
                            return foldl$prime(f(b_2)(_608.value0.value0))(_608.value0.value1);
                        };
                        throw new Error("Failed pattern match");
                    };
                    return g(Data_Lazy.force(uncons(Data_Lazy.monadLazy)(l_1)));
    ...
    return function (b) {
        return function (_604) {
            var foldr$prime = function (b_2) {
                return function (l_1) {
                    var g = function (_607) {
                        if (_607 instanceof Data_Maybe.Nothing) {
                            return Prelude.pure(Data_Lazy.applicativeLazy)(b_2);
                        };
                        if (_607 instanceof Data_Maybe.Just) {
                            return Prelude["<$>"](Data_Lazy.functorLazy)(f(_607.value0.value0))(foldr$prime(b_2)(_607.value0.value1));
                        };
                        throw new Error("Failed pattern match");
                    };
            ...
            return Data_Lazy.force(foldr$prime(b)(_604));
        };
    };
});
