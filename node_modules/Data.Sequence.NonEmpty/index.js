...
var unsnoc = function (_674) {
    var _3122 = Data_Sequence.unsnoc(_674.value1);
    if (_3122 instanceof Data_Maybe.Nothing) {
        return new Data_Tuple.Tuple(Data_Sequence.empty, _674.value0);
    };
    if (_3122 instanceof Data_Maybe.Just) {
        return new Data_Tuple.Tuple(Data_Sequence.cons(_674.value0)(_3122.value0.value0), _3122.value0.value1);
    };
    throw new Error("Failed pattern match");
};
var uncons = function (_673) {
    return new Data_Tuple.Tuple(_673.value0, _673.value1);
};
var toPlain = function (_678) {
    return Data_Sequence.cons(_678.value0)(_678.value1);
};
var take = function (i) {
    return Prelude["<<<"](Prelude.semigroupoidArr)(Data_Sequence.take(i))(toPlain);
};
var tail = function (_676) {
    return _676.value1;
};
var splitAt = function (i) {
    return Prelude["<<<"](Prelude.semigroupoidArr)(Data_Sequence.splitAt(i))(toPlain);
};
var snoc = function (_667) {
    return function (y) {
        return new Seq(_667.value0, Data_Sequence.snoc(_667.value1)(y));
    };
};
...
var showSeq = function (__dict_Show_0) {
    return new Prelude.Show(function (_683) {
        return "(Seq " + (Prelude.show(__dict_Show_0)(_683.value0) + (" " + (Prelude.show(Data_Sequence.showSeq(__dict_Show_0))(_683.value1) + ")")));
    });
};
var semigroupSeq = new Prelude.Semigroup(function (_689) {
    return function (_690) {
        return new Seq(_689.value0, Prelude["<>"](Data_Sequence.semigroupSeq)(Data_Sequence.snoc(_689.value1)(_690.value0))(_690.value1));
    };
});
var length = function (_670) {
    return Data_Sequence.length(_670.value1) + 1;
};
var last = function (_677) {
    return Data_Maybe.maybe(_677.value0)(Prelude.id(Prelude.categoryArr))(Data_Sequence.last(_677.value1));
};
var init = Prelude["<<<"](Prelude.semigroupoidArr)(Data_Tuple.fst)(unsnoc);
var index = function (_679) {
    return function (_680) {
        if (_680 === 0) {
            return new Data_Maybe.Just(_679.value0);
        };
        return Data_Sequence.index(_679.value1)(_680 - 1);
    };
};
var inBounds = function (_671) {
    return function (_672) {
        if (_672 === 0) {
            return true;
        };
        return Data_Sequence.inBounds(_671.value1)(_672 - 1);
    };
};
var head = function (_675) {
    return _675.value0;
};
var functorSeq = new Prelude.Functor(function (f) {
    return function (_688) {
        return new Seq(f(_688.value0), Prelude["<$>"](Data_Sequence.functorSeq)(f)(_688.value1));
    };
});
...
var fromPlainUnsafe = function (xs) {
    var _3173 = Data_Sequence.uncons(xs);
    if (_3173 instanceof Data_Maybe.Just) {
        return new Seq(_3173.value0.value0, _3173.value0.value1);
    };
    throw new Error("Failed pattern match");
};
...
var eqSeq = function (__dict_Eq_7) {
    return new Prelude.Eq(function (x) {
        ...
        return function (_685) {
            return Prelude["=="](__dict_Eq_7)(_684.value0)(_685.value0) && Prelude["=="](Data_Sequence.eqSeq(__dict_Eq_7))(_684.value1)(_685.value1);
        };
    });
};
var ordSeq = function (__dict_Ord_1) {
    return new Prelude.Ord(function () {
        ...
        return function (_687) {
            var _3185 = Prelude.compare(__dict_Ord_1)(_686.value0)(_687.value0);
            if (_3185 instanceof Prelude.EQ) {
                return Prelude.compare(Data_Sequence.ordSeq(__dict_Ord_1))(_686.value1)(_687.value1);
            };
            return _3185;
        };
    });
...
var cons = function (x) {
    return function (_666) {
        return new Seq(x, Data_Sequence.cons(_666.value0)(_666.value1));
    };
};
...
var append = function (_668) {
    return function (_669) {
        return new Seq(_668.value0, Prelude["<>"](Data_Sequence.semigroupSeq)(Data_Sequence.snoc(_668.value1)(_669.value0))(_669.value1));
    };
};
...
var adjust = function (f) {
    return function (_681) {
        return function (_682) {
            if (_681 === 0) {
                return new Seq(f(_682.value0), _682.value1);
            };
            return new Seq(_682.value0, Data_Sequence.adjust(f)(_681 - 1)(_682.value1));
        };
    };
};
