...
var runWithStderr = function (l) {
    return function (t) {
        return function (cb) {
            var handler = function (_275) {
                if (_275 instanceof Data_Either.Right) {
                ...
                if (_275 instanceof Data_Either.Left) {
                    return function __do() {
                        Test_Unit_Console.restorePos();
                        Test_Unit_Console.eraseLine();
                        ...
                        Test_Unit_Console.printFail(_275.value0)();
                        Test_Unit_Console.print("\n")();
                        return cb(_275)();
                    };
                };
...
var runWithConsole = function (l) {
    return function (t) {
        return function (cb) {
            var handler = function (_276) {
                if (_276 instanceof Data_Either.Right) {
                    return function __do() {
                ...
                if (_276 instanceof Data_Either.Left) {
                    return function __do() {
                        Test_Unit_Console.consoleError("\u2620 Failed: " + (l + (" because " + _276.value0)))();
                        return cb(_276)();
                    };
                };
                throw new Error("Failed pattern match");
...
var pickFirst = function (t1) {
    return function (t2) {
        return Control_Monad_Error_Trans.ErrorT(Control_Monad_Cont_Trans.ContT(function (cb) {
            return function __do() {
                var _15 = Control_Monad_Eff_Ref.newRef(false)();
                return (function () {
                    var $$yield = function (t) {
                        return Control_Monad_Cont_Trans.runContT(Control_Monad_Error_Trans.runErrorT(t))(function (res) {
                            return function __do() {
                                var _14 = Control_Monad_Eff_Ref.readRef(_15)();
                                Control_Monad_Eff_Ref.writeRef(_15)(true)();
                                if (_14) {
                                    return Prelude.unit;
                                };
                                if (!_14) {
