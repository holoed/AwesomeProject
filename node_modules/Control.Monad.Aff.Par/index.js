...
var runPar = function (_307) {
    return _307;
};
var functorPar = new Prelude.Functor(function (f) {
    return function (_308) {
        return Prelude["<$>"](Control_Monad_Aff.functorAff)(f)(_308);
    };
});
var applyPar = new Prelude.Apply(function (_309) {
...
var altPar = new Control_Alt.Alt(function (_311) {
