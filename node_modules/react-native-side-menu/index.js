...
var SideMenu = React.createClass({
  ...
  getInitialState: function() {
    return { width: deviceScreen.width, height: deviceScreen.height };
  },
  ...
  componentWillMount: function () {
    ...
    Viewport.getDimensions(this.updateOrientation);
    Viewport.addEventListener(Viewport.events.DEVICE_DIMENSIONS_EVENT, this.updateOrientation);
  },
  ...
  updateOrientation: function(args) {
      ...
      if (args.orientation == 1 || args.orientation == 2) {
          if (deviceScreen.width > deviceScreen.height)
            this.setState({ width: deviceScreen.height, height: deviceScreen.width });
          else
            this.setState({ width: deviceScreen.width, height: deviceScreen.height }); 
        }     
  ...
  handleMoveShouldSetPanResponder: function(e: Object, gestureState: Object) {
    ...
    if (this.props.isMenuEnabled && x > 10 && y < 10) {
      return true;
    }
    return false;
  },
