...
var monadErrorErrorT = function (__dict_Monad_1) {
    return new MonadError(function (m) {
        return function (h) {
            return Control_Monad_Error_Trans.ErrorT(Prelude[">>="](__dict_Monad_1["__superclass_Prelude.Bind_1"]())(Control_Monad_Error_Trans.runErrorT(m))(function (_27) {
                if (_27 instanceof Data_Either.Left) {
                    return Control_Monad_Error_Trans.runErrorT(h(_27.value0));
                };
                if (_27 instanceof Data_Either.Right) {
                    return Prelude["return"](__dict_Monad_1)(new Data_Either.Right(_27.value0));
                };
                throw new Error("Failed pattern match");
            }));
        };
...
var monadErrorEither = new MonadError(function (_293) {
    return function (h) {
        if (_293 instanceof Data_Either.Left) {
            return h(_293.value0);
        };
