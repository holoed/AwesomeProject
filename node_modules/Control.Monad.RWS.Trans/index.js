            ...
            return function (r) {
                return function (s) {
                    return Prelude["<$>"](__dict_Functor_5)(function (see) {
                        var _1161 = {};
                        for (var _1162 in see) {
                            if (see.hasOwnProperty(_1162)) {
                                _1161[_1162] = see[_1162];
                            };
                        };
                        _1161.result = f(see.result);
                        return _1161;
                    })(runRWST(m)(r)(s));
                };
            };
    ...
    return function (__dict_Monoid_11) {
        return new Prelude.Apply(function (f) {
            return function (m) {
                return function (r) {
                    return function (s) {
                        return Prelude[">>="](__dict_Bind_10)(runRWST(f)(r)(s))(function (_269) {
                            return Prelude["<#>"]((__dict_Bind_10["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(runRWST(m)(r)(_269.state))(function (_268) {
                                return mkSee(__dict_Monoid_11)(_268.state)(_269.result(_268.result))(Prelude["++"](__dict_Monoid_11["__superclass_Prelude.Semigroup_0"]())(_269.log)(_268.log));
                            });
                        });
                    };
                };
    ...
    return function (__dict_Monoid_9) {
        return new Prelude.Bind(function (m) {
            return function (f) {
                return function (r) {
                    return function (s) {
                        return Prelude[">>="](__dict_Bind_8)(runRWST(m)(r)(s))(function (_270) {
                            return Prelude["<#>"]((__dict_Bind_8["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(runRWST(f(_270.result))(r)(_270.state))(function (see$prime) {
                                var _1172 = {};
                                for (var _1173 in see$prime) {
                                    if (see$prime.hasOwnProperty(_1173)) {
                                        _1172[_1173] = see$prime[_1173];
                                    };
                                };
                                _1172.log = Prelude["++"](__dict_Monoid_9["__superclass_Prelude.Semigroup_0"]())(_270.log)(see$prime.log);
                                return _1172;
                            });
                        });
                    };
