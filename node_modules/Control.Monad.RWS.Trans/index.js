            ...
            return function (r) {
                return function (s) {
                    return Prelude["<$>"](__dict_Functor_5)(function (see) {
                        var _1199 = {};
                        for (var _1200 in see) {
                            if (see.hasOwnProperty(_1200)) {
                                _1199[_1200] = see[_1200];
                            };
                        };
                        _1199.result = f(see.result);
                        return _1199;
                    })(runRWST(m)(r)(s));
                };
            };
    ...
    return function (__dict_Monoid_11) {
        return new Prelude.Apply(function (f) {
            return function (m) {
                return function (r) {
                    return function (s) {
                        return Prelude[">>="](__dict_Bind_10)(runRWST(f)(r)(s))(function (_280) {
                            return Prelude["<#>"]((__dict_Bind_10["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(runRWST(m)(r)(_280.state))(function (_279) {
                                return mkSee(__dict_Monoid_11)(_279.state)(_280.result(_279.result))(Prelude["++"](__dict_Monoid_11["__superclass_Prelude.Semigroup_0"]())(_280.log)(_279.log));
                            });
                        });
                    };
                };
    ...
    return function (__dict_Monoid_9) {
        return new Prelude.Bind(function (m) {
            return function (f) {
                return function (r) {
                    return function (s) {
                        return Prelude[">>="](__dict_Bind_8)(runRWST(m)(r)(s))(function (_281) {
                            return Prelude["<#>"]((__dict_Bind_8["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(runRWST(f(_281.result))(r)(_281.state))(function (see$prime) {
                                var _1210 = {};
                                for (var _1211 in see$prime) {
                                    if (see$prime.hasOwnProperty(_1211)) {
                                        _1210[_1211] = see$prime[_1211];
                                    };
                                };
                                _1210.log = Prelude["++"](__dict_Monoid_9["__superclass_Prelude.Semigroup_0"]())(_281.log)(see$prime.log);
                                return _1210;
                            });
                        });
                    };
