...
var monadTransStateT = new Control_Monad_Trans.MonadTrans(function (__dict_Monad_2) {
    return function (m) {
        return function (s) {
            return Prelude[">>="](__dict_Monad_2["__superclass_Prelude.Bind_1"]())(m)(function (_21) {
                return Prelude["return"](__dict_Monad_2)(new Data_Tuple.Tuple(_21, s));
            });
        };
    };
});
    ...
    return function (pass) {
        return function (m) {
            return StateT(function (s) {
                return pass(Prelude[">>="](__dict_Monad_5["__superclass_Prelude.Bind_1"]())(runStateT(m)(s))(function (_23) {
                    return Prelude["return"](__dict_Monad_5)(new Data_Tuple.Tuple(new Data_Tuple.Tuple(_23.value0.value0, _23.value1), _23.value0.value1));
                }));
            });
        };
    };
...
var liftListenState = function (__dict_Monad_6) {
    return function (listen) {
        return function (m) {
            return StateT(function (s) {
                return Prelude[">>="](__dict_Monad_6["__superclass_Prelude.Bind_1"]())(listen(runStateT(m)(s)))(function (_22) {
                    return Prelude["return"](__dict_Monad_6)(new Data_Tuple.Tuple(new Data_Tuple.Tuple(_22.value0.value0, _22.value1), _22.value0.value1));
                });
            });
        };
    };
...
var bindStateT = function (__dict_Monad_10) {
    return new Prelude.Bind(function (_297) {
        return function (f) {
            return function (s) {
                return Prelude[">>="](__dict_Monad_10["__superclass_Prelude.Bind_1"]())(_297(s))(function (_20) {
                    return runStateT(f(_20.value0))(_20.value1);
                });
            };
        };
    }, function () {
