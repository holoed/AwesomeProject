...
var bindStateT = function (__dict_Monad_10) {
    return new Prelude.Bind(function (_240) {
        return function (f) {
            return function (s) {
                return Prelude[">>="](__dict_Monad_10["__superclass_Prelude.Bind_1"]())(_240(s))(function (_18) {
