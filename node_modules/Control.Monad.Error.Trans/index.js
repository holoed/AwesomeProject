...
var applyErrorT = function (__dict_Apply_10) {
    return new Prelude.Apply(function (_280) {
        return function (_281) {
            return ErrorT(Prelude["<*>"](__dict_Apply_10)(Prelude["<$>"](__dict_Apply_10["__superclass_Prelude.Functor_0"]())(Control_Apply.lift2(Data_Either.applyEither)(Prelude["$"]))(_280))(_281));
        };
    }, function () {
