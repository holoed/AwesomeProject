            ...
            return function (xs) {
                var go = function (_364) {
                    return function (x) {
                        ...
                        return {
                            init: false, 
                            acc: Prelude["<>"](__dict_Monoid_7["__superclass_Prelude.Semigroup_0"]())(_364.acc)(Prelude["<>"](__dict_Monoid_7["__superclass_Prelude.Semigroup_0"]())(sep)(x))
                        };
                    };
                };
...
var foldableTuple = new Foldable(function (__dict_Monoid_13) {
    return function (f) {
        return function (_348) {
            return f(_348.value1);
        };
    };
}, function (f) {
    return function (z) {
        return function (_347) {
            return f(z)(_347.value1);
        };
    };
}, function (f) {
    return function (z) {
        return function (_346) {
            return f(_346.value1)(z);
        };
    };
});
...
var foldableFirst = new Foldable(function (__dict_Monoid_20) {
    return function (f) {
        return function (_357) {
            return foldMap(foldableMaybe)(__dict_Monoid_20)(f)(_357);
        };
    };
}, function (f) {
    return function (z) {
        return function (_356) {
            return foldl(foldableMaybe)(f)(z)(_356);
        };
    };
}, function (f) {
    return function (z) {
        return function (_355) {
            return foldr(foldableMaybe)(f)(z)(_355);
        };
    };
});
var foldableLast = new Foldable(function (__dict_Monoid_21) {
    return function (f) {
        return function (_360) {
            return foldMap(foldableMaybe)(__dict_Monoid_21)(f)(_360);
        };
    };
}, function (f) {
    return function (z) {
        return function (_359) {
            return foldl(foldableMaybe)(f)(z)(_359);
        };
    };
}, function (f) {
    return function (z) {
        return function (_358) {
            return foldr(foldableMaybe)(f)(z)(_358);
        };
    };
});
var lookup = function (__dict_Eq_22) {
    return function (__dict_Foldable_23) {
        return function (a) {
            return function (f) {
                return Data_Monoid_First.runFirst(foldMap(__dict_Foldable_23)(Data_Monoid_First.monoidFirst)(function (_339) {
                    var _1503 = Prelude["=="](__dict_Eq_22)(a)(_339.value0);
                    if (_1503) {
                        return new Data_Maybe.Just(_339.value1);
                    };
                    if (!_1503) {
...
var find = function (__dict_Foldable_26) {
    return function (p) {
        return function (f) {
            var _1507 = foldMap(__dict_Foldable_26)(Data_Monoid.monoidArray)(function (x) {
                var _1506 = p(x);
                if (_1506) {
                    return [ x ];
                };
            ...
            if (_1507.length >= 1) {
                var _1509 = _1507.slice(1);
                return new Data_Maybe.Just(_1507[0]);
            };
            if (_1507.length === 0) {
                return Data_Maybe.Nothing.value;
            };
