    ...
    return function (__dict_Monoid_3) {
        return function (f) {
            return function (_394) {
                return function (s) {
                    var _1573 = f(s);
                    return Prelude.pure(__dict_Applicative_2)(Control_Monad_RWS_Trans.mkSee(__dict_Monoid_3)(_1573.value1)(_1573.value0)(Data_Monoid.mempty(__dict_Monoid_3)));
                };
            };
        };
    };
...
var put = function (__dict_Applicative_6) {
    return function (__dict_Monoid_7) {
        return function (s) {
            return state(__dict_Applicative_6)(__dict_Monoid_7)(function (_395) {
...
var pass = function (__dict_Monad_8) {
    return function (m) {
        return function (r) {
            return function (s) {
                return Prelude[">>="](__dict_Monad_8["__superclass_Prelude.Bind_1"]())(Control_Monad_RWS_Trans.runRWST(m)(r)(s))(function (_392) {
                    return Prelude.pure(__dict_Monad_8["__superclass_Prelude.Applicative_0"]())({
                        state: _392.state, 
                        result: _392.result.value0, 
                        log: _392.result.value1(_392.log)
                    });
                });
            };
        };
...
var listens = function (__dict_Monad_11) {
    return function (f) {
        return function (m) {
            return function (r) {
                return function (s) {
                    return Prelude[">>="](__dict_Monad_11["__superclass_Prelude.Bind_1"]())(Control_Monad_RWS_Trans.runRWST(m)(r)(s))(function (_393) {
                        return Prelude.pure(__dict_Monad_11["__superclass_Prelude.Applicative_0"]())({
                            state: _393.state, 
                            result: new Data_Tuple.Tuple(_393.result, f(_393.log)), 
                            log: _393.log
                        });
                    });
                };
...
var listen = function (__dict_Monad_12) {
    return function (m) {
        return function (r) {
            return function (s) {
                return Prelude[">>="](__dict_Monad_12["__superclass_Prelude.Bind_1"]())(Control_Monad_RWS_Trans.runRWST(m)(r)(s))(function (_391) {
                    return Prelude.pure(__dict_Monad_12["__superclass_Prelude.Applicative_0"]())({
                        state: _391.state, 
                        result: new Data_Tuple.Tuple(_391.result, _391.log), 
                        log: _391.log
                    });
                });
            };
                ...
                return function (s) {
                    return Prelude[">>="](__dict_Monad_17["__superclass_Prelude.Bind_1"]())(Control_Monad_RWS_Trans.runRWST(m)(r)(s))(function (see) {
                        return Prelude.pure(__dict_Monad_17["__superclass_Prelude.Applicative_0"]())((function () {
                            var _1591 = {};
                            for (var _1592 in see) {
                                if (see.hasOwnProperty(_1592)) {
                                    _1591[_1592] = see[_1592];
                                };
                            };
                            _1591.log = f(see.log);
                            return _1591;
