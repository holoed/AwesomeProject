...
var comonadEnvTuple = new ComonadEnv(function () {
    ...
    return function (_400) {
        return new Data_Tuple.Tuple(f(_400.value0), _400.value1);
    };
});
    ...
    return new ComonadEnv(function () {
        ...
        return function (x) {
            return Control_Comonad_Env_Trans.EnvT((function () {
                var _1603 = Control_Comonad_Env_Trans.runEnvT(x);
                return new Data_Tuple.Tuple(f(_1603.value0), _1603.value1);
            })());
        };
    });
};
