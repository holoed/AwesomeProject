...
var makeVar$prime = function (a) {
    return Prelude[">>="](Control_Monad_Aff.bindAff)(makeVar)(function (_29) {
        return Prelude[">>="](Control_Monad_Aff.bindAff)(putVar(_29)(a))(function () {
            return Prelude["return"](Control_Monad_Aff.monadAff)(_29);
        });
    });
};
