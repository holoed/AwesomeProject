...
var empty = {};;
  ...
  ;
var values = _collect(function (_478) {
    return function (v) {
        return v;
    };
});
...
var fromListWith = function (f) {
    return function (l) {
        return pureST(function __do() {
            ...
            Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(l)(function (_477) {
                return Prelude[">>="](Control_Monad_Eff.bindEff)(_lookupST(_477.value1, f(_477.value1), _477.value0, _45))(Data_StrMap_ST.poke(_45)(_477.value0));
            })();
            return _45;
        });
    };
...
var fromList = function (l) {
    return pureST(function __do() {
        ...
        Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(l)(function (_476) {
            return Data_StrMap_ST.poke(_44)(_476.value0)(_476.value1);
        })();
        return _44;
    });
};
...
var alter = function (f) {
    return function (k) {
        return function (m) {
            var _2281 = f(lookup(k)(m));
            if (_2281 instanceof Data_Maybe.Nothing) {
                return $$delete(k)(m);
            };
            if (_2281 instanceof Data_Maybe.Just) {
                return insert(k)(_2281.value0)(m);
            };
