...
var empty = {};;
  ...
  ;
var values = _collect(function (_378) {
    return function (v) {
        return v;
    };
});
...
var fromListWith = function (f) {
    return function (l) {
        return pureST(function __do() {
            ...
            Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(l)(function (_377) {
                return Prelude[">>="](Control_Monad_Eff.bindEff)(_lookupST(_377.value1, f(_377.value1), _377.value0, _33))(Data_StrMap_ST.poke(_33)(_377.value0));
            })();
            return _33;
        });
    };
...
var fromList = function (l) {
    return pureST(function __do() {
        ...
        Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(l)(function (_376) {
            return Data_StrMap_ST.poke(_32)(_376.value0)(_376.value1);
        })();
        return _32;
    });
};
...
var alter = function (f) {
    return function (k) {
        return function (m) {
            var _1794 = f(lookup(k)(m));
            if (_1794 instanceof Data_Maybe.Nothing) {
                return $$delete(k)(m);
            };
            if (_1794 instanceof Data_Maybe.Just) {
                return insert(k)(_1794.value0)(m);
            };
