...
var empty = {};;
  ...
  ;
var values = _collect(function (_469) {
    return function (v) {
        return v;
    };
});
...
var fromListWith = function (f) {
    return function (l) {
        return pureST(function __do() {
            ...
            Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(l)(function (_468) {
                return Prelude[">>="](Control_Monad_Eff.bindEff)(_lookupST(_468.value1, f(_468.value1), _468.value0, _45))(Data_StrMap_ST.poke(_45)(_468.value0));
            })();
            return _45;
        });
    };
...
var fromList = function (l) {
    return pureST(function __do() {
        ...
        Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(l)(function (_467) {
            return Data_StrMap_ST.poke(_44)(_467.value0)(_467.value1);
        })();
        return _44;
    });
};
