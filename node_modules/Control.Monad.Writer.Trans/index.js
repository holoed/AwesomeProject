...
var functorWriterT = function (__dict_Functor_9) {
    return new Prelude.Functor(function (f) {
        return mapWriterT(Prelude["<$>"](__dict_Functor_9)(function (_278) {
            return new Data_Tuple.Tuple(f(_278.value0), _278.value1);
        }));
    });
};
                ...
                return WriterT((function () {
                    var k = function (_280) {
                        return function (_281) {
                            return new Data_Tuple.Tuple(_280.value0(_281.value0), Prelude["<>"](__dict_Monoid_13["__superclass_Prelude.Semigroup_0"]())(_280.value1)(_281.value1));
                        };
                    };
