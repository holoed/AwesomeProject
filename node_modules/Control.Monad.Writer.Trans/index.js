...
var runWriterT = function (_299) {
    return _299;
};
var monadTransWriterT = function (__dict_Monoid_4) {
    return new Control_Monad_Trans.MonadTrans(function (__dict_Monad_5) {
        return function (m) {
            return WriterT(Prelude[">>="](__dict_Monad_5["__superclass_Prelude.Bind_1"]())(m)(function (_26) {
                return Prelude["return"](__dict_Monad_5)(new Data_Tuple.Tuple(_26, Data_Monoid.mempty(__dict_Monoid_4)));
            }));
        };
    });
};
...
var functorWriterT = function (__dict_Functor_9) {
    return new Prelude.Functor(function (f) {
        return mapWriterT(Prelude["<$>"](__dict_Functor_9)(function (_298) {
            return new Data_Tuple.Tuple(f(_298.value0), _298.value1);
        }));
    });
};
                ...
                return WriterT((function () {
                    var k = function (_300) {
                        return function (_301) {
                            return new Data_Tuple.Tuple(_300.value0(_301.value0), Prelude["<>"](__dict_Monoid_13["__superclass_Prelude.Semigroup_0"]())(_300.value1)(_301.value1));
                        };
                    };
...
var bindWriterT = function (__dict_Monoid_11) {
    return function (__dict_Monad_12) {
        return new Prelude.Bind(function (m) {
            return function (k) {
                return WriterT(Prelude[">>="](__dict_Monad_12["__superclass_Prelude.Bind_1"]())(runWriterT(m))(function (_25) {
                    return Prelude[">>="](__dict_Monad_12["__superclass_Prelude.Bind_1"]())(runWriterT(k(_25.value0)))(function (_24) {
                        return Prelude["return"](__dict_Monad_12)(new Data_Tuple.Tuple(_24.value0, Prelude["<>"](__dict_Monoid_11["__superclass_Prelude.Semigroup_0"]())(_25.value1)(_24.value1)));
                    });
                }));
            };
        }, function () {
