    ...
    return new Prelude.Functor(function (f) {
        return function (_212) {
            return StoreT(new Data_Tuple.Tuple(Prelude["<$>"](__dict_Functor_0)(function (h) {
                return Prelude[">>>"](Prelude.semigroupoidArr)(h)(f);
            })(_212.value0), _212.value1));
        };
    });
};
...
var comonadStoreT = function (__dict_Comonad_3) {
    return new Control_Comonad.Comonad(function () {
        ...
        return Control_Comonad.extract(__dict_Comonad_3)(_214.value0)(_214.value1);
    });
};
module.exports = {
    StoreT: StoreT, 
