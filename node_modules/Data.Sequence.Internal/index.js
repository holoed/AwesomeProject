...
var $times$times$times = function (fa) {
    return function (fb) {
        return function (_433) {
            return new Data_Tuple.Tuple(fa(_433.value0), fb(_433.value1));
        };
    };
};
...
var showKey = function (__dict_Show_5) {
    return new Prelude.Show(function (_448) {
        if (_448 instanceof Key) {
            return "(Key " + (Prelude.show(__dict_Show_5)(_448.value0) + ")");
        };
        if (_448 instanceof NoKey) {
            return "NoKey";
        };
...
var measuredElemKey = new Measured(function (_452) {
    return new Key(_452);
});
var measuredElem = new Measured(function (_435) {
    return 1;
});
...
var traversableElem = new Data_Traversable.Traversable(function () {
    ...
    return function (_445) {
        return fmapElem((__dict_Applicative_17["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(_445);
    };
}, function (__dict_Applicative_16) {
    return function (f) {
        return function (_444) {
            return fmapElem((__dict_Applicative_16["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(f(_444));
        };
    };
});
...
var eqKey = function (__dict_Eq_20) {
    return new Prelude.Eq(function (x) {
        ...
        return function (_447) {
            if (_446 instanceof Key && _447 instanceof Key) {
                return Prelude["=="](__dict_Eq_20)(_446.value0)(_447.value0);
            };
            if (_446 instanceof NoKey && _447 instanceof NoKey) {
                return true;
            };
            return false;
        };
...
var ordKey = function (__dict_Ord_6) {
    return new Prelude.Ord(function () {
        ...
        return function (_451) {
            if (_450 instanceof NoKey) {
                return Prelude.LT.value;
            };
            if (_451 instanceof NoKey) {
                return Prelude.GT.value;
            };
            if (_450 instanceof Key && _451 instanceof Key) {
                return Prelude.compare(__dict_Ord_6)(_450.value0)(_451.value0);
            };
            throw new Error("Failed pattern match");
        };
    });
...
var eqElem = function (__dict_Eq_21) {
    return new Prelude.Eq(function (x) {
        ...
        return function (_437) {
            return Prelude["=="](__dict_Eq_21)(_436)(_437);
        };
    });
};
var ordElem = function (__dict_Ord_7) {
    return new Prelude.Ord(function () {
        ...
        return function (_439) {
            return Prelude.compare(__dict_Ord_7)(_438)(_439);
        };
    });
};
module.exports = {
