        ...
        return function (z) {
            var g = function (_479) {
                if (_479 instanceof Data_Maybe.Just) {
                    return new Yield(_479.value0.value1, Data_Lazy.defer(function (_471) {
                        return unfold(__dict_Monad_2)(f)(_479.value0.value0);
                    }));
                };
                ...
                var g = function (_489) {
                    var h = function (_490) {
                        if (_490 instanceof Yield) {
                            var b$prime = f(_489.value0)(_490.value0);
                            return Data_Maybe.Just.create(new Data_Tuple.Tuple(new Data_Tuple.Tuple(b$prime, Data_Lazy.force(_490.value1)), b$prime));
                        };
                        if (_490 instanceof Skip) {
                            return Data_Maybe.Just.create(new Data_Tuple.Tuple(new Data_Tuple.Tuple(_489.value0, Data_Lazy.force(_490.value0)), _489.value0));
                        };
                    ...
                    return Prelude["<$>"](((__dict_Monad_4["__superclass_Prelude.Applicative_0"]())["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(h)(runListT(_489.value1));
                };
    ...
    return function (f) {
        var g = function (_481) {
            if (_481 instanceof Yield) {
                ...
                return ifThenElse(f(_481.value0))(new Yield(_481.value0, Prelude["<$>"](Data_Lazy.functorLazy)(takeWhile(__dict_Applicative_6)(f))(_481.value1)))(Done.value);
            };
            if (_481 instanceof Skip) {
                return Skip.create(Prelude["<$>"](Data_Lazy.functorLazy)(takeWhile(__dict_Applicative_6)(f))(_481.value0));
            };
            if (_481 instanceof Done) {
                return Done.value;
            };
            throw new Error("Failed pattern match");
        };
...
var uncons = function (__dict_Monad_7) {
    return function (l) {
        var g = function (_486) {
            if (_486 instanceof Yield) {
                return Prelude.pure(__dict_Monad_7["__superclass_Prelude.Applicative_0"]())(Data_Maybe.Just.create(new Data_Tuple.Tuple(_486.value0, Data_Lazy.force(_486.value1))));
            };
            if (_486 instanceof Skip) {
                return uncons(__dict_Monad_7)(Data_Lazy.force(_486.value0));
            };
            if (_486 instanceof Done) {
...
var take = function (__dict_Applicative_15) {
    return function (_475) {
        return function (fa) {
            ...
            var f = function (_480) {
                if (_480 instanceof Yield) {
                    var s$prime = Prelude["<$>"](Data_Lazy.functorLazy)(take(__dict_Applicative_15)(_475 - 1))(_480.value1);
                    return new Yield(_480.value0, s$prime);
                };
                if (_480 instanceof Skip) {
                    var s$prime = Prelude["<$>"](Data_Lazy.functorLazy)(take(__dict_Applicative_15)(_475))(_480.value0);
                    return new Skip(s$prime);
                };
                if (_480 instanceof Done) {
                    return Done.value;
                };
                throw new Error("Failed pattern match");
            };
            ...
            return function (fb) {
                var g = function (_491) {
                    return function (_492) {
                        ...
                        if (_491 instanceof Data_Maybe.Just && _492 instanceof Data_Maybe.Just) {
                            return Prelude["<$>"](((__dict_Monad_16["__superclass_Prelude.Applicative_0"]())["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Prelude.flip(prepend$prime(__dict_Monad_16["__superclass_Prelude.Applicative_0"]()))(Data_Lazy.defer(function (_472) {
                                return zipWith$prime(__dict_Monad_16)(f)(_491.value0.value1)(_492.value0.value1);
                            })))(f(_491.value0.value0)(_492.value0.value0));
                        };
                        throw new Error("Failed pattern match");
                    };
                };
...
var mapMaybe = function (__dict_Functor_22) {
    return function (f) {
        var g = function (_485) {
            if (_485 instanceof Yield) {
                return Data_Maybe.fromMaybe(Skip.create)(Prelude["<$>"](Data_Maybe.functorMaybe)(Yield.create)(f(_485.value0)))(Prelude["<$>"](Data_Lazy.functorLazy)(mapMaybe(__dict_Functor_22)(f))(_485.value1));
            };
            if (_485 instanceof Skip) {
                return Skip.create(Prelude["<$>"](Data_Lazy.functorLazy)(mapMaybe(__dict_Functor_22)(f))(_485.value0));
            };
            if (_485 instanceof Done) {
                return Done.value;
            };
            throw new Error("Failed pattern match");
        };
    ...
    return new Prelude.Functor(function (f) {
        var g = function (_495) {
            if (_495 instanceof Yield) {
                return new Yield(f(_495.value0), Prelude["<$>"](Data_Lazy.functorLazy)(Prelude["<$>"](functorListT(__dict_Functor_27))(f))(_495.value1));
            };
            if (_495 instanceof Skip) {
                return new Skip(Prelude["<$>"](Data_Lazy.functorLazy)(Prelude["<$>"](functorListT(__dict_Functor_27))(f))(_495.value0));
            };
...
var functorZipListT = function (__dict_Functor_26) {
    return new Prelude.Functor(function (f) {
        return function (_496) {
            return ZipListT(Prelude["<$>"](functorListT(__dict_Functor_26))(f)(_496));
        };
    });
};
var fromEffect = function (__dict_Applicative_28) {
    return function (fa) {
        return ListT.create(Prelude["<$>"]((__dict_Applicative_28["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Prelude.flip(Yield.create)(Data_Lazy.defer(function (_470) {
            ...
            return function (l) {
                var g = function (_487) {
                    ...
                    if (_487 instanceof Data_Maybe.Just) {
                        return Prelude[">>="](__dict_Monad_31["__superclass_Prelude.Bind_1"]())(f(b)(_487.value0.value0))(Prelude.flip(loop)(_487.value0.value1));
                    };
                    throw new Error("Failed pattern match");
                };
            ...
            return function (l) {
                var g = function (_488) {
                    ...
                    if (_488 instanceof Data_Maybe.Just) {
                        return loop(f(b)(_488.value0.value0))(_488.value0.value1);
                    };
                    throw new Error("Failed pattern match");
                };
...
var filter = function (__dict_Functor_34) {
    return function (f) {
        var g = function (_484) {
            if (_484 instanceof Yield) {
                var s$prime = Prelude["<$>"](Data_Lazy.functorLazy)(filter(__dict_Functor_34)(f))(_484.value1);
                var _2352 = f(_484.value0);
                if (_2352) {
                    return new Yield(_484.value0, s$prime);
                };
                if (!_2352) {
                    return new Skip(s$prime);
                };
            ...
            if (_484 instanceof Skip) {
                var s$prime = Prelude["<$>"](Data_Lazy.functorLazy)(filter(__dict_Functor_34)(f))(_484.value0);
                return new Skip(s$prime);
            };
            if (_484 instanceof Done) {
                return Done.value;
            };
            throw new Error("Failed pattern match");
        };
...
var dropWhile = function (__dict_Applicative_35) {
    return function (f) {
        var g = function (_483) {
            if (_483 instanceof Yield) {
                var _2357 = f(_483.value0);
                if (_2357) {
                    return new Skip(Prelude["<$>"](Data_Lazy.functorLazy)(dropWhile(__dict_Applicative_35)(f))(_483.value1));
                };
                if (!_2357) {
                    return new Yield(_483.value0, _483.value1);
                };
                throw new Error("Failed pattern match");
            };
            if (_483 instanceof Skip) {
                return Skip.create(Prelude["<$>"](Data_Lazy.functorLazy)(dropWhile(__dict_Applicative_35)(f))(_483.value0));
            };
            if (_483 instanceof Done) {
                return Done.value;
            };
            throw new Error("Failed pattern match");
        };
...
var drop = function (__dict_Applicative_36) {
    return function (_476) {
        return function (fa) {
            ...
            var f = function (_482) {
                if (_482 instanceof Yield) {
                    var s$prime = Prelude["<$>"](Data_Lazy.functorLazy)(drop(__dict_Applicative_36)(_476 - 1))(_482.value1);
                    return new Skip(s$prime);
                };
                if (_482 instanceof Skip) {
                    var s$prime = Prelude["<$>"](Data_Lazy.functorLazy)(drop(__dict_Applicative_36)(_476))(_482.value0);
                    return new Skip(s$prime);
                };
                if (_482 instanceof Done) {
                    return Done.value;
                };
                throw new Error("Failed pattern match");
            };
        ...
        return function (b) {
            var go = function (_497) {
                ...
                if (_497 instanceof Data_Maybe.Just) {
                    return cons$prime(__dict_Monad_38["__superclass_Prelude.Applicative_0"]())(Prelude.pure(Data_Lazy.applicativeLazy)(_497.value0.value0))(Data_Lazy.defer(function (_473) {
                        return go(f(_497.value0.value1));
                    }));
                };
                throw new Error("Failed pattern match");
            };
...
var concat = function (__dict_Applicative_39) {
    return function (x) {
        return function (y) {
            var f = function (_478) {
                if (_478 instanceof Yield) {
                    return new Yield(_478.value0, Prelude["<$>"](Data_Lazy.functorLazy)(Prelude.flip(Prelude["<>"](semigroupListT(__dict_Applicative_39)))(y))(_478.value1));
                };
                if (_478 instanceof Skip) {
                    return new Skip(Prelude["<$>"](Data_Lazy.functorLazy)(Prelude.flip(Prelude["<>"](semigroupListT(__dict_Applicative_39)))(y))(_478.value0));
                };
                if (_478 instanceof Done) {
...
var semigroupZipListT = function (__dict_Applicative_3) {
    return new Prelude.Semigroup(function (_493) {
        return function (_494) {
            return ZipListT(Prelude["<>"](semigroupListT(__dict_Applicative_3))(_493)(_494));
        };
    });
};
...
var applyZipListT = function (__dict_Monad_43) {
    return new Prelude.Apply(function (_498) {
        return function (_499) {
            ...
            return ZipListT(zipWith(__dict_Monad_43)(g)(_498)(_499));
        };
    }, function () {
...
var bindListT = function (__dict_Monad_42) {
    return new Prelude.Bind(function (fa) {
        return function (f) {
            var g = function (_500) {
                if (_500 instanceof Yield) {
                    var h = function (s_1) {
                        return concat(__dict_Monad_42["__superclass_Prelude.Applicative_0"]())(f(_500.value0))(Prelude[">>="](bindListT(__dict_Monad_42))(s_1)(f));
                    };
                    return new Skip(Prelude["<$>"](Data_Lazy.functorLazy)(h)(_500.value1));
                };
                if (_500 instanceof Skip) {
                    var h = function (s_2) {
                        return Prelude[">>="](bindListT(__dict_Monad_42))(s_2)(f);
                    };
                    return new Skip(Prelude["<$>"](Data_Lazy.functorLazy)(h)(_500.value0));
                };
                if (_500 instanceof Done) {
                    return Done.value;
                };
                throw new Error("Failed pattern match");
            };
...
var altZipListT = function (__dict_Applicative_49) {
    return new Control_Alt.Alt(function (_501) {
        return function (_502) {
            return ZipListT(Control_Alt["<|>"](altListT(__dict_Applicative_49))(_501)(_502));
        };
    }, function () {
